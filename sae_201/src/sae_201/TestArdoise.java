...
public class TestArdoise {
    ...
    static class ThreadA extends Thread {
        ...
        public void run() {
            ...
            Quadrilatere Tour = new Quadrilatere("Tour", point1, point2);

            point1 = new PointPlan(80, 140);
            point2 = new PointPlan(180, 140);
            point3 = new PointPlan(180, 198);
            Quadrilatere Corps_maison = new Quadrilatere("Corps_maison", point1, point2);

            point1 = new PointPlan(120, 170);
            point2 = new PointPlan(140, 170);
            point3 = new PointPlan(140, 198);
            Quadrilatere porte_maison = new Quadrilatere("porte_maison", point1, point2);
